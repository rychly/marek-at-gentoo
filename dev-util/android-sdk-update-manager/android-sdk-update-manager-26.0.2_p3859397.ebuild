...
HOMEPAGE="https://developer.android.com/studio/#downloads"
SRC_URI="https://dl.google.com/android/repository/sdk-tools-linux-${PV##*_p}.zip"
IUSE=""
RESTRICT="mirror"
...
QA_FLAGS_IGNORED_x86="
	...
	${ANDROID_SDK_DIR/\/}/tools/emulator-check
	${ANDROID_SDK_DIR/\/}/tools/mksdcard
	${ANDROID_SDK_DIR/\/}/tools/lib/monitor-x86/monitor
	${ANDROID_SDK_DIR/\/}/tools/lib/monitor-x86_64/monitor
"
