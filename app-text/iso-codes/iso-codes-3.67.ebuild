...
# $Id$
#
# adopted from https://gitweb.gentoo.org/repo/gentoo.git/plain/app-text/iso-codes/iso-codes-3.67.ebuild?id=afd1d443ac4ddd72f265a58cf873c010701e2cc2
# before dropping from Portage, see https://gitweb.gentoo.org/repo/gentoo.git/log/app-text/iso-codes/iso-codes-3.67.ebuild
# KEYWORDS unmasked as in https://gitweb.gentoo.org/repo/gentoo.git/tree/app-text/iso-codes/iso-codes-3.68.ebuild
# kept due to: iso_xxxx.xml files are not provided anymore in the iso-codes tarball since version 3.68, they are generated during the Make phase, python3 is required, see https://bugs.gentoo.org/show_bug.cgi?id=584672
