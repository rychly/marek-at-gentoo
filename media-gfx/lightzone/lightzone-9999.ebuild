...
# $Header: $
# adopted from: https://raw.githubusercontent.com/ktgw0316/LightZone/f5adc4696768360e28d4d2a68b669834b1a6b810/linux/lightzone-9999.ebuild
# and: moved KEYWORDS into if-else; added RESTRICT=mirror; suffixed SRC_URI="... -> ${P}.tar.gz"; installed symlink to jh.jar into /use/share/lightzone/lib
...
if [[ ${PV} == "9999" ]]; then
	...
	KEYWORDS="~x86 ~amd64"
	RESTRICT=mirror
	SRC_URI="https://github.com/Aries85/LightZone/archive/${PV}.tar.gz -> ${P}.tar.gz"
fi
...
src_install() {
	...
	ln -s ../../javahelp/lib/jh.jar "${D}/${_javadir}/${PN}/lib"
