...
src_compile() {
	...
	if use amd64; then
		sed -i 's/\(CPPFLAGS\|LDFLAGS\|dwg2dxf_LDFLAGS\|CXXFLAGS\) = /old_\1 = /g' "${S}/dwg2dxf/Makefile" \
		|| die "unable to prepare for 32-bit architecture"
