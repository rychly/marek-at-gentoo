...
DESCRIPTION="Sourcery CodeBench is a complete development environment for embedded C/C++ development on ARM, Power, ColdFire, and other architectures (GCC 4.7)."
...
LICENSE=""
KEYWORDS="~x86 ~amd64" # GCC >v4.5 is incompatible with STM's Contiki
